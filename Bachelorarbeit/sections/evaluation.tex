...
\noindent
To answer \textbf{G1.Q1-G1.Q3}, it is necessary to determine the \textit{Precision and Recall} of the identified microservices, the identified functionalities and the identified data objects.
