...
A more detailed description of the CoCoME system can be found in the literature \cite{CoCoMEOld}\cite{CoCoMETechnical}. The next section provides information about the system requirements specifications in form of use cases.
