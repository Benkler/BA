...
This step finalizes the microservice identification approach. In the following, it is applied to the case study CoCoME which is introduced in Chapter \ref{ch:CoCoME}. 
